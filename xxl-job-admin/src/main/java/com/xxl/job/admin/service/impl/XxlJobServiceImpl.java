...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public ReturnT<String> update(XxlJobInfo jobInfo) {
        ...
        exists_jobInfo.setJobGroup(jobInfo.getJobGroup())
                ...
                .setAlarmEmail(jobInfo.getAlarmEmail())
                .setScheduleType(jobInfo.getScheduleType())
                .setScheduleConf(jobInfo.getScheduleConf())
                .setMisfireStrategy(jobInfo.getMisfireStrategy())
                .setExecutorRouteStrategy(jobInfo.getExecutorRouteStrategy())
                ...
                .setExecutorFailRetryCount(jobInfo.getExecutorFailRetryCount())
                .setChildJobId(jobInfo.getChildJobId())
                .setTriggerNextTime(nextTriggerTime);
